...
int si5351_set_freq(int channel, uint32_t, int, enum si5351_clock, unsigned int r_div);
int si5351_set_pll(int channel, uint32_t, enum si5351_pll);
int si5351_clock_enable(int channel, enum si5351_clock, uint8_t);
int si5351_drive_strength(int channel,enum si5351_clock, enum si5351_drive);
int si5351_update_status(int channel);
void si5351_set_correction(int channel, int32_t);
